...
# 재생속도 2배 빠르게
./ffmpeg -i LandingPageScroll_3.mov -vf "setpts=(1/2)*PTS" -an LandingPageScroll_3.mp4
# 재생속도 4배 빠르게
./ffmpeg -i LandingPageScroll_3.mov -vf "setpts=(1/4)*PTS" -an LandingPageScroll_3.mp4
# 재생속도 2배 느리게
./ffmpeg -i LandingPageScroll_3.mov -vf "setpts=(2/1)*PTS" -an LandingPageScroll_3.mp4
# 재생속도 4배 느리게
